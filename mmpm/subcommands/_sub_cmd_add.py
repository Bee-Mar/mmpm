"""Command line options for 'add' subcommand"""
...
class Add(SubCmd):
    """
    The 'Add' subcommand allows users to install MagicMirror packages to their modules folder, and handles much of the dependency installation
