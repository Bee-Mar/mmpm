...
export class MagicMirrorPackageAPI extends BaseAPI {
  ...
  public postDetails(pkg: MagicMirrorPackage): Promise<APIResponse> {
    console.log(
      `Requesting to get remote package details for ${pkg.title} (${pkg.repository})`,
    );
