...
export class SharedStoreService {
  ...
  private packagesSubj: BehaviorSubject<MagicMirrorPackage[]> =
    new BehaviorSubject<Array<MagicMirrorPackage>>([]);
  public readonly packages: Observable<MagicMirrorPackage[]> =
    this.packagesSubj.asObservable();

  private dbInfoSubj: BehaviorSubject<DatabaseInfo> =
    new BehaviorSubject<DatabaseInfo>({});
  public readonly dbInfo: Observable<DatabaseInfo> =
    this.dbInfoSubj.asObservable();

  private upgradeableSubj: BehaviorSubject<UpgradableDetails> =
    new BehaviorSubject<UpgradableDetails>({
      mmpm: false,
      MagicMirror: false,
      packages: [],
    });
  public readonly upgradable: Observable<UpgradableDetails> =
    this.upgradeableSubj.asObservable();
