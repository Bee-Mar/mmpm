...
@NgModule({
  declarations: [AppComponent, MmpmMarketPlaceComponent, LogStreamViewerComponent, ConfigEditorComponent, DatabaseInfoComponent, CustomPackageManagerComponent, PackageDetailsViewerComponent],
